...
export default function Header() {
  ...
  return (
    <header className="border-b-3 border-charcoal dark:border-dark-border bg-cream/80 dark:bg-dark-bg/90 backdrop-blur-sm sticky top-0 z-50 pt-safe">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-12 sm:h-16">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2 sm:gap-3 group">
            <div className="w-8 h-8 sm:w-10 sm:h-10 grid grid-cols-2 gap-0.5 bg-charcoal p-0.5">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <select
              ...
              className="h-8 sm:h-10 px-2 sm:px-3 font-mono text-xs font-bold border-3 border-charcoal dark:border-dark-border bg-cream dark:bg-dark-bg hover:bg-charcoal hover:text-cream dark:hover:bg-lime dark:hover:text-charcoal dark:hover:border-lime transition-colors cursor-pointer focus:outline-none"
            >
            ...
            <button
              onClick={toggleTheme}
              className="w-8 h-8 sm:w-10 sm:h-10 border-3 border-charcoal dark:border-dark-border flex items-center justify-center hover:bg-charcoal hover:text-cream dark:hover:bg-lime dark:hover:text-charcoal dark:hover:border-lime transition-colors"
